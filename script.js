...
function drawLeftPlayer() {
    ...
    const size = game.leftScore * 10;

    context.beginPath();
    context.fillStyle = leftPlayer.color;
    context.roundRect(leftPlayer.positionX, leftPlayer.positionY, leftPlayer.width, leftPlayer.height - size, leftPlayer.cornerRadius);
    context.fill();
    context.closePath();
}
...
function drawRightPlayer() {
    ...
    const size = game.rightScore * 10;

    context.beginPath();
    context.fillStyle = rightPlayer.color;
    context.roundRect(rightPlayer.positionX, rightPlayer.positionY, rightPlayer.width, rightPlayer.height - size, rightPlayer.cornerRadius);
    context.fill();
    context.closePath();
}
...
function drawBall() {
    ...
    context.lineTo(canvas.width / 2, 900);
    context.lineWidth = 5;
